# Глава VII — Управление на паметта в защитен режим: Странициране
...
|------|----------|---------|
| **PG** | CR0[31] | Разрешава/забранява странициране (от i386) |
| **PSE** | CR4[4] | Page Size Extension: разрешава 4 MB и 2 MB страници (от Pentium) |
| **PAE** | CR4[5] | Physical Address Extension: 36-битов физически адрес (от Pentium Pro) |
...
**Основна идея:**
- Линейното адресно пространство (4 GB или 256 TB) се разделя на **фиксирани блокове — страници**
- Физическата памет се разделя на **странични кадри** (frame) със същия размер
- Трансформацията: линеен адрес → физически адрес чрез **многониивова таблична структура**
- **TLB (Translation Lookaside Buffer)**: кеш памет за нивата на транслация
